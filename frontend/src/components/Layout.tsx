...
const Layout = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-white dark:bg-[#0B1222] overflow-x-hidden">
      {isAuthenticated && <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${scrolled ? 'bg-white/80 dark:bg-[#0B1222]/80' : 'bg-white dark:bg-[#0B1222]'} backdrop-blur-lg shadow`}>
          ...
          {}
          <div className="md:hidden absolute top-16 inset-x-0 bg-white dark:bg-[#0B1222] backdrop-blur-lg shadow-lg z-50" style={{
