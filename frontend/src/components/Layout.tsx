...
const Layout = () => {
  ...
  return <div className="min-h-screen bg-gray-50">
      {isAuthenticated && <header className="bg-white shadow">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <h1 className="text-xl font-semibold">GitHub Dashboard</h1>
              <button onClick={() => navigate(isAssignedView ? '/' : '/assigned')} className={`px-4 py-2 rounded-lg transition-colors ${isAssignedView ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}>
