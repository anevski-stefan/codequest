...
const MyAssignedIssues = () => {
  ...
  const {
    ...
    isLoading,
    error
  } = useQuery('assignedIssues', getAssignedIssues);
  ...
  if (error instanceof Error) {
    return <div className="text-center text-red-600 p-4 mb-4 bg-red-50 rounded-lg">
  ...
  return <>
      <div className="bg-white shadow overflow-hidden sm:rounded-md">
        ...
        <ul className="divide-y divide-gray-200">
          {data?.issues.map((issue: Issue) => <li key={issue.id}>
