...
const CodeBuddy = () => {
  ...
  return <>
      ...
      <div className={`fixed bottom-4 right-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg flex flex-col transition-all duration-300 ${isExpanded ? 'w-[450px] h-[600px]' : 'w-72 h-16'}`}>
