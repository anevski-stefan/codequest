...
export default function HackathonList() {
  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col gap-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <div className="flex items-center gap-2">
              {data?.totalHackathons !== undefined && data.totalHackathons > 0 && <p className="mt-2 text-gray-600 dark:text-gray-400">
                  Showing {data.hackathons.length} of {data.totalHackathons} hackathons
                </p>}
              {isFetching && !isLoading && <span className="mt-2 text-sm text-gray-500 dark:text-gray-400 animate-pulse">
                  Updating...
                </span>}
            </div>
          </div>
        ...
        {data && data.totalPages > 1 && <div className="mt-12">
