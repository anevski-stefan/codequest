...
export const NotificationsDropdown = () => {
  ...
  return (
    <Popover className="relative">
      {({ close }) => (
        <>
          <Popover.Button className="relative p-2 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all outline-none focus-visible:ring-2 focus-visible:ring-blue-500">
