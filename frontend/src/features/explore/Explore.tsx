...
const Explore = () => {
  ...
  return <div className="flex items-center justify-center min-h-[calc(100vh-48px)]">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {error && <div className="text-center text-red-600 dark:text-red-400">
            An error occurred while fetching repositories
          </div>}

        {data?.items && <div className="grid gap-6">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-4 flex items-center space-x-4">
                      {repo.language && <span className="text-sm text-gray-500 dark:text-gray-400">
                          {repo.language}
                        </span>}
