...
const ContributorProfile = () => {
  ...
  return <div className="flex flex-col md:flex-row flex-1 dark:bg-[#0B1222] mt-8 gap-6 px-4 md:px-8">
      {}
      <div className="md:w-80 shrink-0">
        <div className="sticky top-8">
          ...
          y: 0
            ...
            <div className="flex flex-col items-center">
              <img src={user.avatar_url} alt={user.name} className="w-32 h-32 rounded-full border-4 border-white dark:border-gray-700 shadow-lg" />
        ...
        y: 0
            ...
            login: string;
                  ...
                  <img src={org.avatar_url} alt={org.login} className="w-12 h-12 rounded-lg" title={org.login} />
                </a>)}
            </div>
          </motion.div>}
      </div>
