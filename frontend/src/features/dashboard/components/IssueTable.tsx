        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
            {issues.map(issue => <tr key={`${issue.repository?.fullName}-${issue.number}`} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                ...
                <td className="px-6 py-4">
                  <a href={`https://github.com/${issue.repository?.fullName}`} target="_blank" rel="noopener noreferrer" className="text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
