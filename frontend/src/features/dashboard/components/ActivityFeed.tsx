...
const ActivityFeed = () => {
  ...
  if (isLoading) {
    return <div className="animate-pulse space-y-4 bg-gray-900 dark:bg-gray-900">
      {[...Array(5)].map((_, i) => <div key={i} className="h-16 bg-gray-800 dark:bg-gray-800 rounded"></div>)}
    </div>;
  }
  if (error) {
  ...
  if (!activities || activities.length === 0) {
    return <div className="bg-gray-900 dark:bg-gray-900 p-4 rounded-lg">
  ...
  return <div className="space-y-4 bg-gray-900 dark:bg-gray-900 p-4 rounded-lg">
      {activities.map((activity: Activity) => <div key={activity.id} className="flex items-start space-x-3 p-4 bg-gray-800 dark:bg-gray-800 rounded-lg border border-gray-700">
          ...
          <div className="flex-1">
            ...
            {activity.payload.commits && <div className="mt-1 text-sm text-gray-400 dark:text-gray-400">
