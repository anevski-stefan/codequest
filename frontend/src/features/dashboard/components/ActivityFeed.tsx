...
const ActivityFeed = () => {
  ...
  return <div className="space-y-4">
      {activities?.map((activity: Activity) => <div key={activity.id} className="flex items-start space-x-3 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="flex-1">
            ...
            {activity.payload.commits && <div className="mt-1 text-sm text-gray-600">
