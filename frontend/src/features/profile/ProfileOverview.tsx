const ProfileOverview = () => {
  return (
    <div className="space-y-6">
      <div className="bg-white/80 dark:bg-[#0B1222]/80 backdrop-blur-lg rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold mb-4 dark:text-white">Overview</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-blue-50 dark:bg-[#0B1222]/50 rounded-lg">
          ...
          <div className="p-4 bg-green-50 dark:bg-[#0B1222]/50 rounded-lg">
          ...
          <div className="p-4 bg-purple-50 dark:bg-[#0B1222]/50 rounded-lg">
