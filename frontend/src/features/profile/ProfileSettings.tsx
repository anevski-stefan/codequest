...
const ProfileSettings = () => {
  ...
  return <div className="bg-white/80 dark:bg-[#0B1222]/80 backdrop-blur-lg rounded-lg shadow p-6 border border-gray-200 dark:border-white/10">
      ...
      <div className="flex justify-end">
        <button type="button" className="px-4 py-2 bg-blue-600 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-800 transition-colors shadow-sm" onClick={() => {
