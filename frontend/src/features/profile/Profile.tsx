      ...
      <div className="w-80 shrink-0 dark:bg-[#0B1222] border-r border-gray-200 dark:border-white/10">
        <div className="p-6">
          ...
          y: 0
            ...
            <img src={user?.avatar_url} alt="Profile" className="w-32 h-32 rounded-full border-4 border-white dark:border-gray-700 shadow-lg" />
            ...
            <div className="mt-6 w-full space-y-3">
              ...
              {user?.created_at && <div className="flex items-center text-gray-600 dark:text-gray-300">
