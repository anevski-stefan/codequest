          ...
          <nav className="mt-8">
            <ul className="space-y-2">
              {navigationItems.map(item => <li key={item.path}>
                ...
                isActive
              }) => `flex items-center px-4 py-2 rounded-lg transition-colors ${isActive ? 'bg-blue-50/50 dark:bg-white/5 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-50/50 dark:hover:bg-white/5'}`}>
