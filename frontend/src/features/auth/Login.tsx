...
const Login = () => {
  ...
  return <div className="flex min-h-screen w-full bg-white dark:bg-gradient-to-br dark:from-gray-950 dark:via-[#0B1222] dark:to-gray-900">
      {}
            ...
            <div className="space-y-12 w-full max-w-md">
              <div className="space-y-6">
                ...
                <div className="inline-flex items-center px-4 py-2 bg-purple-50 dark:bg-purple-500/10 rounded-full border border-purple-100 dark:border-purple-500/20">
                  <a href="/hackathons" className="text-xs font-semibold text-purple-600 dark:text-purple-400">
