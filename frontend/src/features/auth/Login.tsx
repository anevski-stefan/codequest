              ...
              <div className="space-y-4">
                <div className="space-y-2 sm:space-y-4">
                  ...
                  <div className="inline-flex items-center px-4 py-2 sm:px-4 sm:py-2 bg-purple-50 dark:bg-purple-500/10 rounded-full border border-purple-100 dark:border-purple-500/20">
                    <a href="/hackathons" className="text-xs sm:text-xs font-semibold text-purple-600 dark:text-purple-400">
              ...
              <div className="bg-gray-50 dark:bg-white/5 rounded-2xl p-8 border border-gray-200 
                ...
                <div className="space-y-8">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <Link to="/privacy" className="underline hover:text-gray-700 dark:hover:text-gray-300" target="_blank" rel="noopener noreferrer">
                      privacy policy
                    </Link> and{' '}
                    <Link to="/terms" className="underline hover:text-gray-700 dark:hover:text-gray-300" target="_blank" rel="noopener noreferrer">
                      terms of service
                    </Link>.
                  </p>
                </div>
