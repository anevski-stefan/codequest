---
name: code-reviewer
description: Read-only reviewer for Code Quest diffs. Use after finishing a feature, before committing, or when asked whether a change is OK. Returns ranked findings with file:line evidence and never edits files.
kind: local
max_turns: 40
---
